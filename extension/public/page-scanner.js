...
(function() {
  try {
    ...
    var company = {
      ...
      industry: 'Unknown',
      type: companyType,
      hasCareerPage: safeLinks.some(function(l){return l.includes('/careers')||l.includes('/jobs');}),
      hasBlog: safeLinks.some(function(l){return l.includes('/blog')||l.includes('/articles');}),
      hasPricingPage: safeLinks.some(function(l){return l.includes('/pricing')||l.includes('/plans');}),
      hasFreeTrial: bodyText.includes('free trial') || bodyText.includes('start free'),
      hasDemoPage: bodyText.includes('book a demo') || bodyText.includes('request demo'),
      hasCaseStudies: safeLinks.some(function(l){return l.includes('/case-stud')||l.includes('/customers');}),
      hasApiDocs: safeLinks.some(function(l){return l.includes('/api-reference')||l.includes('/api-docs')||l.includes('/developers');}) && bodyText.includes('api') && (bodyText.includes('documentation')||bodyText.includes('endpoint')),
      hasIntegrationsPage: safeLinks.some(function(l){return l.includes('/integrations');}),
      estimatedSize: '',
